...
<label>id_materia</label>
    ...
    <input type="text" name="nombre_materia" value="<?php echo $alumno['nombre_materia']; ?>" required>
    ...
    <input type="number" name="horas_semana" value="<?php echo $alumno['horas_semana']; ?>" required>
