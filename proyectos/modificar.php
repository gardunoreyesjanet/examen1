...
<fieldset>
  ...
  <form method="get" action="">
    ...
    <select name="id_alumno" onchange="this.form.submit()" required id_alumno="id_alumno">
      ...
      while ($fila = mysqli_fetch_assoc($resultado)) {
        $selected = (isset($_GET['id_alumno']) && $_GET['id_alumno'] == $fila['id']) ? 'selected' : '';
  ...
  <form method="post" action="crud_modificar.php">
...
<label>id_alumno</label>
    ...
    <input type="text" name="nombre_alumno" value="<?php echo $alumno['nombre_alumno']; ?>" required>
    
    <label>apellido_alumno</label>
    <input type="text" name="apellido_alumno" value="<?php echo $alumno['apellido_alumno']; ?>" required>
    <label>fecha_nac</label>
    <input type="date" name="fecha_nac" value="<?php echo $alumno['fecha_nac']; ?>" required>
